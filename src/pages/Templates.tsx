      ...
      <header className="border-b border-border bg-card/50 backdrop-blur-sm sticky top-0 z-50">
        <div className="container mx-auto px-4 h-16 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-4">
            <Link to="/my-cvs" className="text-muted-foreground hover:text-foreground transition-colors text-sm">
              Meus CVs
            </Link>
      ...
      <main className="container mx-auto px-4 py-8">
        <div className="text-center mb-8">
          ...
          <p className="text-muted-foreground max-w-xl mx-auto">
            Selecione um dos nossos templates profissionais e comece a criar 
          ...
          {filteredTemplates.map(template => (
            ...
            >
              <CardContent className="p-0">
                {/* Template Preview */}
                <div className="aspect-[3/4] bg-[hsl(var(--cv-preview-bg))] p-4 relative">
                  {/* Badges */}
                  ...
                  {/* Mini CV Preview */}
                  <div className="cv-paper h-full p-3 text-[6px]">
                    <div 
